...
#     # Get parameters for the Servo node
#     servo_yaml = load_yaml("brc_arm_config", "config/servo_simulated_config.yaml")
#     servo_params = {"moveit_servo": servo_yaml}

#     # RViz
#     rviz_config_file = (
#         get_package_share_directory("moveit_servo") + "/cronfig/panda_demo_rviz_config.rviz"
#     )
#     rviz_node = Node(
#         package="rviz2",
#         executable="rviz2",
...
#                 plugin="tf2_ros::StaticTransformBroadcasterNode",
#                 name="static_tf2_broadcaster",
#                 parameters=[{"child_frame_id": "/wrist2_link", "frame_id": "/base_link"}],
#             ),
#             ComposableNode(
#                 package="moveit_servo",
#                 plugin="moveit_servo::JoyToServoPub",
